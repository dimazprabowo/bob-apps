<x-app-layout title="Detail Laporan Armada">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Detail Laporan Armada
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="{{ route('reports.armada') }}" wire:navigate
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $booking->booker_divisi ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">No. HP</p>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $booking->booker_phone ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Email</p>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $booking->booker_email ?? '-' }}</p>
                            </div>
                            <div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $booking->approved_at?->format('d M Y H:i') }}</p>
                                </div>
                            </div>
                        </div>
                    @endif
