<x-guest-booking-layout color="blue">
    ...
    {{-- Header --}}
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <a href="{{ route('booking.armada.form') }}" wire:navigate
                       class="group flex items-center gap-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 hover:shadow-lg hover:border-blue-400 dark:hover:border-blue-500 transition-all">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transition-transform group-hover:translate-x-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                    </a>
                ...
                <a href="{{ route('booking.check-status') }}" wire:navigate
                   class="group flex items-center gap-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl border border-indigo-200 dark:border-indigo-800 p-5 hover:shadow-lg hover:border-indigo-400 dark:hover:border-indigo-500 transition-all mb-6">
                    ...
                    <svg class="w-5 h-5 text-indigo-400 transition-transform group-hover:translate-x-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                </a>
    ...
    <div class="text-center pt-6 border-t border-gray-200 dark:border-gray-700">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            @if(auth()->check())
                <a href="{{ route('dashboard') }}" wire:navigate class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors">Dashboard</a>
            @else
