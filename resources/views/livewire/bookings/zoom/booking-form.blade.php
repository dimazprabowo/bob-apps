    ...
    @if($showSuccess)
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <x-navigate-button href="{{ route('booking.check-status') }}" variant="purple" size="lg" loadingText="Memuat..." class="flex-1 sm:flex-none">
                            Cek Status
                        </x-navigate-button>
            ...
            @else
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
                    ...
                    <form wire:submit.prevent="submit" class="space-y-5">
                        ...
                        <livewire:bookings.booking-availability :type="'zoom'" :bookingDate="$booking_date" :key="'zoom-avail'" />
