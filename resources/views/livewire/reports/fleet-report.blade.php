                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($dailyStats as $day)
                            <tr wire:key="fs-{{ $day['date'] }}" class="hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($bookings as $booking)
                        <tr wire:key="fr-{{ $booking->id }}" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            <td class="px-4 py-3 text-sm font-mono text-gray-900 dark:text-white">{{ $booking->booking_code }}</td>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">{{ $booking->vehicle?->name }}</td>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">{{ $booking->booker_name }}</td>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white">{{ $booking->booking_date->format('d M Y') }}</td>
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-white max-w-[200px] truncate">{{ $booking->destination }}</td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium">
                                <a href="{{ route('reports.armada.show', $booking) }}" wire:navigate
