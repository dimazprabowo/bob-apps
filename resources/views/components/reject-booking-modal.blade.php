@props([
    'show' => false,
    'confirmMethod' => 'reject',
    'title' => 'Tolak Booking',
    'description' => 'Jelaskan alasan penolakan booking ini.',
])
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-6">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md z-10 p-6 text-center">
                ...
                <div class="flex items-center justify-center gap-3">
                    <x-cancel-button wire:click="closeRejectModal" target="closeRejectModal" variant="secondary" />
