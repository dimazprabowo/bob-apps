...
class RolePermissionService
{
    ...
    public function buildPermissionGroups(): array
    {
        $groupMapping = [
            ...
            'Booking Armada' => [
                ['name' => 'vehicle_bookings_view',         'label' => 'Lihat Booking Armada'],
                ['name' => 'vehicle_bookings_create',       'label' => 'Ajukan Booking Armada'],
                ['name' => 'vehicle_bookings_update',       'label' => 'Edit Booking Armada'],
                ['name' => 'vehicle_bookings_delete',       'label' => 'Hapus Booking Armada'],
            ...
            'Booking Zoom' => [
                ['name' => 'zoom_bookings_view',         'label' => 'Lihat Booking Zoom'],
                ['name' => 'zoom_bookings_create',       'label' => 'Ajukan Booking Zoom'],
                ['name' => 'zoom_bookings_update',       'label' => 'Edit Booking Zoom'],
                ['name' => 'zoom_bookings_delete',       'label' => 'Hapus Booking Zoom'],
            ...
            'Booking Ruangan' => [
                ['name' => 'room_bookings_view',         'label' => 'Lihat Booking Ruangan'],
                ['name' => 'room_bookings_create',       'label' => 'Ajukan Booking Ruangan'],
                ['name' => 'room_bookings_update',       'label' => 'Edit Booking Ruangan'],
                ['name' => 'room_bookings_delete',       'label' => 'Hapus Booking Ruangan'],
