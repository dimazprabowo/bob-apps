...
class RoomReport extends Component
{
    ...
    public function exportExcel()
    {
        ...
        return (new RoomBookingsExport(null, null, $this->dateFrom ?: null, $this->dateTo ?: null))
            ->download('laporan-ruangan-' . now()->format('Y-m-d-His') . '.xlsx');
    }
    ...
    public function exportPdf(RoomBookingService $service)
    {
        ...
        $pdf = Pdf::loadView('exports.room-bookings-pdf', [
            'bookings' => $bookings,
        ...
        return response()->streamDownload(
            fn () => print($pdf->output()),
            'laporan-ruangan-' . now()->format('Y-m-d-His') . '.pdf'
        );
    }
    ...
    public function render(RoomBookingService $service)
    {
        ...
        return view('livewire.reports.room-report', [
            'bookings' => $bookings,
            'stats' => $stats,
